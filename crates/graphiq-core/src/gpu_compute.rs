    ...
    impl GpuContext {
        ...
        pub fn dispatch_tf(
                ...
                });
            {
                ...
                pass.dispatch_workgroups((n_symbols + 63) / 64, 1, 1);
            }
            self.queue.submit(std::iter::once(enc.finish()));
        ...
        pub fn dispatch_idf(&self, doc_freq: &[f32], n_symbols: u32) -> Option<Vec<f32>> {
                ...
                });
            {
                ...
                pass.set_bind_group(0, &bg, &[]);
                pass.dispatch_workgroups((n_terms + 255) / 256, 1, 1);
            }
            self.queue.submit(std::iter::once(enc.finish()));
        ...
        pub fn dispatch_bridge(
                ...
                });
            {
                ...
                pass.set_bind_group(0, &bg, &[]);
                pass.dispatch_workgroups((n + 31) / 32, 1, 1);
            }
            self.queue.submit(std::iter::once(enc.finish()));
        ...
        pub fn dispatch_score(
                ...
                });
            {
                ...
                pass.set_bind_group(0, &bg, &[]);
                pass.dispatch_workgroups((nc + 63) / 64, 1, 1);
            }
            self.queue.submit(std::iter::once(enc.finish()));
