...
- Database: a clean checkout of GraphIQ itself, 185 files, 2,119 symbols, 6,586 edges
...
|---|---:|---:|---:|
| Metal | 18,076 us | 26,040 us | 166 |
| CPU (`GRAPHIQ_DISABLE_GPU=1`) | 21,111 us | 22,001 us | 0 |

Metal was approximately 14% faster at median latency for this workload. Its
...
```text
resident_upload=1us transient_upload=81us submit=21us readback=9807us
```

The process RSS was 84 MB before and 86 MB at peak for this run (the CPU
baseline was 74 MB before and 76 MB at peak).
